...
| Folder | Contents |
|---|---|
| `Code/python/` | THE production simulation engine. `engine/` is the model, `settings/plan_settings.py` holds every per-plan decision, `reference/` is the verified older lineage, `validation/` the comparison tools. See `Code/python/README.md`. Restructured 2026-07-30. |
