...
- **`Pipeline/062026/`** contains the repeatable run-control workflow for the active run: the canonical 38-plan list, local PowerShell runner, Engaging Slurm job-array scripts, remote upload/submit/fetch wrapper, and the all-plan assumption audit. See `Documentation/062026_run_pipeline.md`.
...
- Check current local status by inventorying `Results/Runs/062026/`, and check current remote status with `Pipeline/062026/remote_062026.ps1 -Action inventory`.
