...
DisabilityPayoutRate <-  135707000/5984083555
...
MainRes_Tier1 <- Main_Current(active_t1,inactive_t1,COLA_t1,WageYears_t1,BenefitCap_t1,
                              BenefitFactor_t1,RetirementStart_t1,NyearFullBenefit_t1,CurrentTier=T)
proc.time() - ptm
