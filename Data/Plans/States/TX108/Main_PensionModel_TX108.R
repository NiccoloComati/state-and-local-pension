...
#DisabilityPayoutRate <-  177627306/40904273685
...
EmployeeContributionRate <- .08
EmployerContributionRate <- .08
...
MainRes_Tier4 <- Main_Current(active_t4,inactive_t4,COLA_t4,WageYears_t4,BenefitCap_t4,
                              BenefitFactor_t4,RetirementStart_t4,NyearFullBenefit_t4,CurrentTier=T)
...
save.image(file = "TX108/TX108_101723.RData")
