...
#DisabilityPayoutRate <-  1450731/8592885
...
#Default Cola for calculating annuity
COLA_c <- PPD$cola
...
## (UNSURE) The earliest age people can retire
RetirementMax <- 104
...
#SeparationRate <- ConstantFill(asy_seprate)
...
MainRes_Tier2 <- Main_Current(active_t2,inactive_t2,COLA_t2,WageYears_t2,BenefitCap_t2,
                              BenefitFactor_t2,RetirementStart_t2,NyearFullBenefit_t2,CurrentTier=T)
...
#Sum Cash Flows
main_cf <- MainRes_Tier1[[2]]  + MainRes_Tier2[[2]] 
...
save.image(file = "SC100/SC100_101723.RData")
