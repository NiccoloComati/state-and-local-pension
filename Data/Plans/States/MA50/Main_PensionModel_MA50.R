...
DisabilityPayoutRate <-  9305286/344325485
#DisabilityPayoutRate <- .004
...
main_cf <- MainRes_Tier1[[2]]  + MainRes_Tier2[[2]] +MainRes_Tier3[[2]] +
  MainRes_Tier4[[2]] +MainRes_Tier5[[2]] +MainRes_Tier6[[2]]
...
cash_inflows <- MainRes_Tier1[[3]]  + MainRes_Tier2[[3]]+ MainRes_Tier3[[3]]+
  MainRes_Tier4[[3]]+ MainRes_Tier5[[3]]+ MainRes_Tier6[[3]]
...
AAL <- MainRes_Tier1[[1]]+MainRes_Tier2[[1]]+RetRes[[1]]+ MainRes_Tier3[[1]]+
  MainRes_Tier4[[1]]+ MainRes_Tier5[[1]]+ MainRes_Tier6[[1]]
...
save.image(file = "MA50/MA50_PlanRetirementRate.RData")
