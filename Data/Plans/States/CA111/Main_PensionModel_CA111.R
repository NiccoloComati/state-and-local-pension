...
model_PVFB <- sum(MainRes_Tier1[[4]][1,])+sum(MainRes_Tier2[[4]][1,])+sum(MainRes_Tier3[[4]][1,])+RetRes[[1]][1,1]
...
save.image(file = "CA111/CA111_latest.RData")
