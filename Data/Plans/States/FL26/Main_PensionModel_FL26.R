...
model_PVFB <- sum(MainRes_Tier1[[4]][1,])+sum(MainRes_Tier2[[4]][1,])+RetRes[[1]][1,1]
...
inactive_model <- sum(MainRes_Tier1[[4]][1,2])+ sum(MainRes_Tier2[[4]][1,2])
...
save.image(file = "FL26/FL26_latest.RData")
