...
availableData <-  c(T,T,T,T,T,F,F,F,F)
...
#Get plan info
planinfo <- read_excel("../../Data/Common/states/ppd-data-latest_fy2023.xlsx", sheet = "ppd-data-latest", col_names=TRUE)
...
refundReturn <- get_inflation_assumption(plan, planinfo)
...
#errors <- read.csv("Results/Output/plan_errors.csv",stringsAsFactors = F)


scaling <- 1#+errors[errors$plan==plan,"EAN"]/100
...
MainRes_Tier1 <-list(array(0,dim(MainRes_Tier3[[1]])),array(0,dim(MainRes_Tier3[[2]])),
                     array(0,dim(MainRes_Tier3[[3]])),array(0,dim(MainRes_Tier3[[4]])))


MainRes_Tier2 <-list(array(0,dim(MainRes_Tier3[[1]])),array(0,dim(MainRes_Tier3[[2]])),
                       array(0,dim(MainRes_Tier3[[3]])),array(0,dim(MainRes_Tier3[[4]])))
