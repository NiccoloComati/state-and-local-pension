...
#Additional info
PPD <- read.csv("../../Data/Common/states/PPD_planlevel_main.csv", stringsAsFactors = F)
...
tierinfo <- read_excel("../../Data/Common/states/planchanges_main.xlsx", sheet = "in", col_names=TRUE)
